...
const RoadMap = (props) => {
    ...
    return (
        <div className='saira-stencil-one main-content d-flex flex-wrap flex-lg-nowrap text-black position-relative'>
            ...
            {mode != 0 && <div className='rm-popup roboto-mono d-flex flex-column'>
                <div className='btn btn-rm-close' onClick={() => {setMode(0);}}>X</div>
    ...
    We are taking sure steps along this path to provide our members with benefits due to their support. Our project, which is developing day by day, has always kept its goal at the top since the first day. We aim to make money by entertaining. Our ecosystem is based on a happy future. Check out our Ecosystem Roadmap for more.<br/>
    ...
    We do not proceed distanced from our audience. Moving forward on the common path is the most favorable for our future. Therefore, this future that we will build together including our members will undoubtedly be great.<br/>
    While we are doing all this, our members will be able to build, have fun, earn money and connect with thousands of members that alike themselves. Imagine that you are guided by the scenario of the future and finally you can live in that world. We're creating this.<br/>
    Nordia For The Future is undoubtedly a long-term project. We are working to make you feel this world even without the Internet. These are the designs of the future. A world that will exist over the time.<br/>
    We want to create an error-free ecosystem by having many utilities in it.<br/>
...
Our mod team, which consists of experts in the field of NFT and DeFi, also undertakes the communication of our Community.
                    ...
                    {mode == 3 && <div className='popup-content pt-3'>
                        <div>
                            ...
                            <div>
                            The Nordia For Future NFT Collection, consisting of 6 classes and consisting of 10,021 pieces, is prepared by our artists and presented to the community. Each member carries their own Nordia For Future NFT(s).<br/>                            
                            </div>
                            <div className='pt-3'>Each nft created plays an important role in the Nordia Ecosystem.</div>
                        </div>
                        <div className='pt-4'>
                            <div className='d-flex justify-content-between align-items-end'>
                                <div className='subtitle'>
...
NRD coin will be the main currency of the ecosystem and they can be exchanged with other cryptocurrencies.
                    ...
                    {mode == 5 && <div className='popup-content pt-3'>
                        <div>
                            ...
                            <div>
                            As NFF brand, we step into street wear and fashion. We produce conceptual clothing, jewelry, accessories and futuristic icon products in many areas. They will be fully wearable, wearable and displayable. To the whole world.
                            </div>
                        </div>
                        <div className='pt-4'>
                            <div className='d-flex justify-content-between align-items-end'>
...
most will do architectural ventures. In addition to these, we will be serving the whole world.
                    ...
                    {mode == 6 && <div className='popup-content pt-3'>
                        <div>
                            ...
                            <div>
                            There are 10,020 unique characters made for players, consisting of 7 different classes in total. You can now get your characters in 2D as NFT, but each character is prepared in 3D for the game. Characters are open to empowerment.
                            </div>
                        </div>
                        <div className='pt-4'>
                            <div className='d-flex justify-content-between align-items-end'>
