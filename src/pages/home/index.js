...
const Home = (props) => {
    ...
    return (
        <>
            <div className='d-flex justify-content-between top-bar roboto'>
                <div className='logo flex-fill'>
                    <a href="/"><img src={LOGO} alt='logo'/></a>
                </div>
                <div className='d-flex tp-ag f-16 align-items-center flex-fill justify-content-between'>
                    <a href="#home" className='btn text-white text-decoration-none'>HOME</a>
                    <a href="#team" className='btn text-white text-decoration-none'>TEAM</a>
                    <a href="#about" className='btn text-white text-decoration-none'>ABOUT</a>
                    <a href="#nft" className='btn text-white text-decoration-none'>NFT</a>
                    <a href="#roadmap" className='btn text-white text-decoration-none'>ROADMAP</a>
                    <div className='btn btn-join f-14 text-white'>JOIN US</div>
                </div>                
            </div>
